...
- **drift recovery, `Reconcile`, or retry of `pending_*`** → v0.2 milestone; see README "Roadmap"
- **role-update cascade to all users in a role** → v0.2 milestone; ties in with `Options.SynadiaCallDelay` (currently unused)
